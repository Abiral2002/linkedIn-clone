...
function AddPost(props) {
  ...
  const sendPost = async (e) => {
    if (e.keyCode === 13) {
      e.preventDefault();
      try {
        let data = addDoc(props.collections, {
          name: "Abiral lamsal",
    ...
    <div className="add_post">
      ...
      <div className="upper_addpost">
        <Avatar
          ...
          src="https://media-exp1.licdn.com/dms/image/C5603AQHVDLfhEkC-_w/profile-displayphoto-shrink_100_100/0/1640449087702?e=1656547200&v=beta&t=gTon9Tt-pFLJZuvAtXrsJRb4VzErLA6Ve-mPhGyODwQ"
        />
        <input
          value={inputValue}
          onKeyDown={sendPost}
      ...
      <div className="lower_addpost">
        {addPostIcon({
          icon: <AddPhotoAlternateIcon style={{ color: "green" }} />,
          title: "Photo",
        })}
        {addPostIcon({
        ...
        {addPostIcon({
          icon: <EventIcon style={{ color: "#f5ce42" }} />,
          title: "Event",
        })}
        {addPostIcon({
          icon: <NewspaperIcon style={{ color: "#f5429e" }} />,
          title: "Article",
        })}
      </div>
    </div>
